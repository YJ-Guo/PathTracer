...
{
    return Bounds3f(b.pMin - Vector3f(delta, delta, delta),
...
inline bool Parallel(const Vector3f& v1, const Vector3f& v2)
{
    Vector3f diff = glm::normalize(v1) - glm::normalize(v2);
