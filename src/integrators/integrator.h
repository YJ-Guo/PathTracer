...
public:
    ...
    virtual Color3f Li(const Ray& r, const Scene& scene, std::shared_ptr<Sampler> sampler, int depth) const = 0;
...
protected:
    Scene *scene;
    Camera *camera;			// A pointer to the Camera instance stored in MyGL.
